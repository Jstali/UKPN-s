      ...
      if (item.events && item.events.length > 0) {
        item.events.forEach(event => {
          ...
          results.push({
            ...
            destinationPath: event.Destination_Folder || event.Destination_Path || event.destination_path || event.destinationPath || event.destinationfilepath || event.DestinationPath || '',
            destinationFileName: event.Destination_fileName || event.Destination_FileName || event.Destination_file_name || event.destinationFileName || event.destinationfilename || event.DestinationFileName || '',
